...
<html lang="en">
  ...
  <head>
    ...
    <link href="css/business-casual.min.css" rel="stylesheet">
      <script type="text/javascript">
            ...
            function abreTelaAtualizar() {
                location.href = "atualizarVaga.php"
            }
            function abreTelaDeletar() {
                location.href = "deletaVaga.php"
            }
      </script>
  </head>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item px-lg-4">
              ...
              <li class="nav-item px-lg-4">
                  <a class="nav-link text-uppercase text-expanded" href="adm.php">Voltar a página de login</a>
              </li>
    ...
    <center>
    <form class="form-horizontal" method="POST" action="trabalheConosco.php">
      <fieldset style="color: white;">

        <!-- Form Name -->
        <legend style="text-align: center">Cadastrar uma nova vaga</legend>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <button name ="idConfirmar" value="idConfirmar" id="idConfirmar" class="btn-success">Inserir nova vaga</button>
              <button id="idVizualizar" name="idVizualizar" class="btn btn-info" onclick="abreTelaDeCurriculos()">Vizualizar Currículos</button><br><hr>
              <button id="idAtualizar" name="idAtualizar" class="btn btn-secondary" onclick="abreTelaAtualizar()">Atualizar Vaga</button>
              <button id="idExcluir" name="idExcluir" class="btn btn-danger" onclick="abreTelaDeletar()">Deletar Vaga</button>
          </div>
        </div>
    ...
    if (isset($_POST["idConfirmar"])) {
        if (cadastravaga($link, $_POST["nomeVaga"], $_POST["descricaoVaga"], $_POST["escolaridadeMinima"],
            $_POST["preRequisitos"])) {
    ...
    if (isset($_POST["idAtualizar"])) {
        if(atualizaVagaEmprego($link,$_SESSION["idVaga"],$_POST["nomeVaga"],$_POST["descricaoVaga"],
    ...
    if (isset($_POST["idExcluir"])){
        if (deletaVagaDeEmprego($link,$_SESSION['idVaga'])){
